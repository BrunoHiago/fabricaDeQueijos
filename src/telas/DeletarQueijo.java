 ...
 * @author bruno
 */
public class DeletarQueijo extends javax.swing.JFrame {

    /**
     * Creates new form DeletarQueijo
     */
    public DeletarQueijo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deletar Queijo");
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        if(txtId.getText().isBlank()){
            ...
            conexao.removeQueijo(Integer.parseInt(txtId.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeletarQueijo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeletarQueijo().setVisible(true);
            }
        });
    }
